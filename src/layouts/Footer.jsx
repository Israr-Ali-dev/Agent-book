  ...
  return (
    <>
      <footer className="bg-[#000518] text-white pt-12 pb-8 px-4 my-5">
          ...
          <div className="w-full md:w-3/4 block sm:flex text-sm mt-6 lg:mt-0">
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
              ...
              <li>
                <a
                  href="#"
                  className="inline-block py-2 pl-3 pr-5  text-gray-lightest hover:text-white no-underline"
                >
                  About
                </a>
              </li>
        ...
        <div className="container mx-auto pt-4 mt-8 border-t border-gray-light flex flex-col gap-5 md:flex-row justify-between items-center">
